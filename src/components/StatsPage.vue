...
import { computed } from 'vue';
    ...
    const userIndex = computed(() => usersStore.usersByRank.findIndex(user => user.id == loginStore.loggedUserId))

    const nextUser = computed(() => usersStore.usersByRank[userIndex.value > 0 ? userIndex.value - 1 : 0])
    ...
    .filter(opponent => 
        opponent.id != user.value!.id &&
        opponent.postsAmount >= user.value!.postsAmount &&
        opponent.postsAmount < postsNeededToSurpass.value + user.value!.postsAmount)
    .length
</script>
<template>
    <div class="hero bg-base-200">
        <div class="hero-content flex-col w-full">
            <div class="flex w-full justify-between">
                ...
                <button type="submit" class="btn btn-primary rounded-full" @click="logout()">Logout</button>
            </div>
            <div class="stats max-lg:stats-vertical shadow my-16">
                <div class="stat place-items-center">
                    <div class="stat-figure text-secondary max-lg:hidden">
                    ...
                    <div class="stat-value">{{ userIndex + 1}}°</div>
                ...
                <div class="stat place-items-center">
                    ...
                    <div class="stat-desc" v-else>You are first! Keep posting before {{ usersStore.usersByRank[1].name }} catches up!</div>
                </div>
                <div class="stat place-items-center">
